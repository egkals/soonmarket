...
function SingupPage() {
    ...
    // 이름, 아이디, 패스워드, 패스워드 체크, 이메일, 닉네임, 전화번호, 주소 상태 정의
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('mb_nickname', mb_nickname);
                    ...
                    <form id="form-elements" onSubmit={handleSubmit}>
                        ...
                        <div className='form-element'>
                            <input 
                                ...
                                className="form-control"
                                value={mb_nickname}
                                onChange={(e) => setmb_nickname(e.target.value)}
                            />
                        </div>
                        {/* 전화번호 형식이 아니면 에러 메시지 */}
